                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('category.update', $category->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_name" class="form-control" value="{{ $category->_categoryname }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" class="form-control">
                                        ...
                                        <option value="{{ $row->id }}" {{ $category->parent_id == $row->id ? 'selected':'' }}>{{ $row->category_name }}</option>
                                        @endforeach
                                    </select>
                                    <p class="text-danger">{{ $errors->first('category_name') }}</p>
                                </div>
