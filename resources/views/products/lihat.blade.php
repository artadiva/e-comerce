        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel">
                            <form action="/products/{{$products->id}}/diskon_insert" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Weight dalam gram (g)</label>
                 ...
                 @foreach($products_detail as $cat)

                                        @if(empty($cat->percentage))
                                        @elseif($cat->end < now())
                                        @else
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel"> <h1>Diskon</h1>
                            ...
                            <form action="/products/diskon_insert" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="percentage" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value=" {{$cat->percentage}}%">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tanggal Mulai</label>
                                    <input name="start" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value=" {{$cat->start}} ">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Tanggal Selesai</label>
                                    <input name="end" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value=" {{$cat->end}} ">
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel"> <h1>Category</h1>
                            <form action="/products/category_insert" method="POST">
                                ...
                                <div class="form-group">
                                    <div id="category" name="category_id" class="form-control" id="exampleInputEmail1">
                                      @foreach($products_detail as $cat)
