...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        $parent = Category::getParent()->orderBy('category_name', 'ASC')->get();
    ...
    public function store(Request $request)
{
	...
	public function edit($id)
	{
	    ...
	    $parent = Category::getParent()->orderBy('category_name', 'ASC')->get(); //INI SAMA DENGAN QUERY YANG ADA PADA METHOD INDEX
